...
import com.example.pindaofenleilibrary.OtherAdapter;
import com.example.pindaofenleilibrary.view.MyGridView;

import java.util.ArrayList;
import java.util.List;

public class TablayoutDetailActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tablayout_detail);
        initView();
    }
    ...
    public void initView() {
        ...
        tab_iv = (ImageView) findViewById(R.id.tab_fan);
        mUserList.add("推荐");
        mUserList.add("本地");
        mUserList.add("社会");
        mUserList.add("娱乐");
        ...
        tab_iv.setOnClickListener(this);
    }
